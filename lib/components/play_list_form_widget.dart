...
import 'play_list_form_model.dart';
export 'play_list_form_model.dart';

class PlayListFormWidget extends StatefulWidget {
  const PlayListFormWidget({super.key});
...
class _PlayListFormWidgetState extends State<PlayListFormWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayListFormModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    width: double.infinity,
                    child: TextFormField(
                      controller: _model.inputURLTextController,
                      focusNode: _model.inputURLFocusNode,
                      autofocus: false,
                      obscureText: false,
                      decoration: InputDecoration(
                        isDense: true,
                      ...
                      minLines: 1,
                      cursorColor: FlutterFlowTheme.of(context).primaryText,
                      validator: _model.inputURLTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
