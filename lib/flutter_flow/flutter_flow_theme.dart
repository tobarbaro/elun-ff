...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF7874C4);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFCABEB2);
  late Color alternate = const Color(0xFFD9D9D9);
  late Color primaryText = const Color(0xFF5D5D5D);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFF75B6FF);
  late Color accent1 = const Color(0xFF7874C4);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0xFFEEE0D4);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFFEAC00);
  late Color error = const Color(0xFFFD4A24);
