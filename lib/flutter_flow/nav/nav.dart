...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: EvaluationWidget.routeName,
          path: EvaluationWidget.routePath,
          builder: (context, params) => EvaluationWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: ExercisesWidget.routePath,
          builder: (context, params) => ExercisesWidget(),
        ),
        FFRoute(
          name: ExerciseSingleWidget.routeName,
          path: ExerciseSingleWidget.routePath,
          asyncParams: {
            'exercise': getDoc(['exercises'], ExercisesRecord.fromSnapshot),
          },
          builder: (context, params) => ExerciseSingleWidget(
        ...
        FFRoute(
          name: ExerciseFormWidget.routeName,
          path: ExerciseFormWidget.routePath,
          asyncParams: {
            'exercise': getDoc(['exercises'], ExercisesRecord.fromSnapshot),
          },
          builder: (context, params) => ExerciseFormWidget(
            exercise: params.getParam(
              'exercise',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: PostSingleWidget.routeName,
          path: PostSingleWidget.routePath,
          asyncParams: {
            'post': getDoc(['posts'], PostsRecord.fromSnapshot),
          },
          builder: (context, params) => PostSingleWidget(
        ...
        FFRoute(
          name: ConfigurationsWidget.routeName,
          path: ConfigurationsWidget.routePath,
